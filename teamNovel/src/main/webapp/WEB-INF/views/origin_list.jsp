...
<div class="tab-pane show active" id="webtoon" role="tabpanel"><br />		
	<div class="container">
	  <div class="row">
	  		<div class="col">
	  			<div class="card-imgs">
	  				<a href="novel_detail.do?novel_title=SSS급 죽어야 사는 헌터">
			...
			<div class="col">
	  			<div class="card-imgs">
		  			<a href="novel_detail.do?novel_title=곱게 키웠더니, 짐승">    			
	    			...
	    			<img class="img-hover" src="https://comicthumb-phinf.pstatic.net/20190910_71/pocket_1568092961185Kdmq3_JPEG/_%2C_%28%29.jpg?type=m260" class="card-img-top" alt="곱게짐승">
	    			</a>
	    		</div>
	    		<div class="card-body">
			...
			<div class="col">
	  			<div class="card-imgs">
		  			<a href="novel_detail.do?novel_title=공작부인의 50가지 티 레시피">    			
	    			...
	    			<img class="img-hover" src="https://dn-img-page.kakao.com/download/resource?kid=Ri1C0/hyfMVWI2Zk/9lzHK22y21OGmPDyZcKY21&filename=th3" class="card-img-top" alt="공작티">
	    			</a>
	    		</div>
	    		<div class="card-body">
			...
			<div class="col">
	  			<div class="card-imgs">
		  			<a href="novel_detail.do?novel_title=광마회귀">    			
			...
			<div class="col">
	  			<div class="card-imgs">
		  			<a href="novel_detail.do?novel_title=광해의 연인">    			
			...
			<div class="col">
  			<div class="card-imgs">
		  			<a href="novel_detail.do?novel_title=괴물 공작가의 계약 공녀">    			
			...
			<div class="col">
	  		<div class="card-imgs">
			  		<a href="novel_detail.do?novel_title=괴물 황태자의 아내가 되었습니다">
			...
			<div class="col">
		  	<div class="card-imgs">
			  		<a href="novel_detail.do?novel_title=구경하는 들러리양">
			...
			<div class="col">
		  	<div class="card-imgs">
				  	<a href="novel_detail.do?novel_title=구사일생 로맨스">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=그 오빠들을 조심해!">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=그 악녀를 조심하세요!">
	    			...
	    			<img class="img-hover" src="https://comicthumb-phinf.pstatic.net/20200218_241/pocket_1581991768224HNav1_JPEG/___1.jpg?type=m260" class="card-img-top" alt="그악조심">
    			</a>
	    		</div>
	    		<div class="card-body">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=그녀가 공작저로 가야 했던 사정">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=그래서 나는 안티팬과 결혼했다">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=그림자 신부">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=김 비서가 왜 그럴까">
	    			...
	    			<img class="img-hover" src="https://dn-img-page.kakao.com/download/resource?kid=usEn2/hylSBqIdbG/7MObbnb2c6P88OWecN1eZ1&filename=th3" class="card-img-top" alt="김비서">
	   			</a>
	    		</div>
	    		<div class="card-body">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=나 혼자만 레벨업">
			...
			<div class="col">
	  		<div class="card-imgs">
				<a href="novel_detail.do?novel_title=나는 이 집 아이">
	    			...
	    			<img class="img-hover" src="https://comicthumb-phinf.pstatic.net/20221229_234/pocket_1672309219217FndGy_JPEG/cover1.jpg?type=m260" class="card-img-top" alt="난집">
	    		</a>
	    		</div>
	    		<div class="card-body">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=낙원의 이론">
			...
			<div class="col">
	  		<div class="card-imgs">
			  		<a href="novel_detail.do?novel_title=남편이 미모를 숨김">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=내가 키운 S급들">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=네가 죽기를 바랄 때가 있었다">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=녹음의 관">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=다정한 그대를 지키는 방법">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=닥터 최태수">
	    			...
	    			<img class="img-hover" src="https://dn-img-page.kakao.com/download/resource?kid=bhMa3y/hyzTXzI4xo/ruOHqz5PVlrWZ9IWcN7sBk&filename=th3" class="card-img-top" alt="닥터최">
	   			</a>
	    		</div>
	    		<div class="card-body">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=달빛조각사">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=당신의 이해를 돕기 위하여">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=대마법사의 딸">
	    			...
	    			<img class="img-hover" src="https://dn-img-page.kakao.com/download/resource?kid=bPcQZx/hyLjgIwkk8/Ka3bfDKuyxVtdM1kNDgwT1&filename=th3" class="card-img-top" alt="대마법딸">
	   			</a>
	    		</div>
	    		<div class="card-body">
			...
			<div class="col">
	  		<div class="card-imgs">
				<a href="novel_detail.do?novel_title=데뷔 못 하면 죽는 병 걸림">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=두 번 사는 랭커">
	    			...
	    			<img class="img-hover" src="https://dn-img-page.kakao.com/download/resource?kid=rQ4kT/hyZ8Aezxs5/Ut1XCiHmNxnajU9mPjvvC1&filename=th3" class="card-img-top" alt="두랭">
	   			</a>
	    		</div>
	    		<div class="card-body">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=뜻대로 하세요">
	    			...
	    			<img class="img-hover" src="https://dn-img-page.kakao.com/download/resource?kid=bPk0IX/hyhBoB8dh7/UABM5iRxm8GSa9x42LTYu0&filename=th3" alt="뜻하">
    			</a>
	    		</div>
	    		<div class="card-body">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=레이디 베이비">
	    			...
	    			<img class="img-hover" src="https://comicthumb-phinf.pstatic.net/20210923_116/pocket_1632335392502g2Ms1_JPEG/4.jpg?type=m260" alt="레베">
    			</a>
	    		</div>
	    		<div class="card-body">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=마른 가지에 바람처럼">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=만렙부터 레벨업">
			...
			<div class="col">
	  		<div class="card-imgs">
		  		<a href="novel_detail.do?novel_title=백작가의 망나니가 되었다">  	
			...
			<div class="col">
	  		<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=버림 받은 황비">
	    			...
	    			<img class="img-hover" src="https://dn-img-page.kakao.com/download/resource?kid=bkcDA0/hyfMVnUjdM/pyd6dsbj1Gm5ZLWbNcO2LK&filename=th3" alt="버림받은황비">
	   			</a>
		    </div>
	    	<div class="card-body">
			...
			<div class="col">
	  		<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=빙의자를 위한 특혜">
	    			...
	    			<img class="img-hover" src="https://dn-img-page.kakao.com/download/resource?kid=rcmyG/hzp2g22Bwu/IGXU3jHsZMwigM3JA78KH1&filename=th3" alt="빙특혜">
	    		</a>
	    		</div>
	    		<div class="card-body">
...
<div class="tab-pane fade" id="drama" role="tabpanel"><br />	
	<div class="container">
	  <div class="row">
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=구르미 그린 달빛">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=누나팬닷컴">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=미남당 사건 수첩">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=올드맨">
	    			<img class="img" src="https://pds.skyedaily.com/news_data/1414990408zop3TSp9CUEa.jpg" class="card-img-top" alt="올드맨">
	    			<img class="img-hover" src="https://dn-img-page.kakao.com/download/resource?kid=NJAUKBxTWnebMJY2&filename=th3" class="card-img-top" alt="올드맨">
				</a>
	    		</div>
	    		<div class="card-body">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=법대로 사랑하라">
	    			...
	    			<img class="img-hover" src="https://comicthumb-phinf.pstatic.net/20220826_232/pocket_1661475463543qF87P_JPEG/accordingtothelaw.jpg?type=m260" class="card-img-top" alt="법대로 사랑하라">
				</a>
	    		</div>
		   	    	<div class="card-body">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=사내맞선">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=설렘주의보">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=선배, 그 립스틱 바르지 마요">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=성스러운 아이돌">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=어게인 마이 라이프">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=애타는 로맨스">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=꽃선비 열애사">
	    			<img class="img" src="https://w.namu.la/s/58c241da0c8005117d5a197dcaf33d13868ea850fa5f0786c20116fe3ec0d29dcc5513a48fef40da6136289c87fa45443afd94df83a9f1207eaebc29ea2c58465e19229e8e2188be576c05ed2b32cc3f01a4c3824a706c9311a6d139c46db621" class="card-img-top" alt="꽃선비열애사">
	    			<img class="img-hover" src="https://comicthumb-phinf.pstatic.net/20150818_264/pocket_1439879540961Xa4Xd_JPEG/1.jpg?type=m260" class="card-img-top" alt="꽃선비열애사">
				</a>
	    		</div>
		   	    		<div class="card-body">
	      			<h5 class="card-title">꽃선비 열애사</h5>
				   	<p class="card-text">원작: 김정화</p>
				   		<div class="platform_logos">
				   			<a class="platform_series" href="https://series.naver.com/novel/detail.series?productNo=1727696" target="_blank">네이버시리즈</a>
				   		</div>
				   	<p class="card-text"><small class="text-muted"> SBS / 2023년 3월 방영 예정</small></p>
				</div>
			</div>
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=옷소매 붉은 끝동">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=저스티스">
	    			<img class="img" src="https://scf.static.kbs.co.kr/image/NBCONTENTSMYLOVEKBS/NBCONTENTSMYLOVEKBS_70000000328949_20190723_20190723090800___EDITOR_01.jpg" class="card-img-top" alt="저스티스">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=진심이 닿다">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=재벌집 막내아들">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=탑 매니지먼트">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  				<a href="novel_detail.do?novel_title=해시의 신루">
	  		...
	  		<div class="col">
	  			<div class="card-imgs">
	  				<a href="novel_detail.do?novel_title=열녀박씨 계약결혼뎐">  
	  				<img class="img" src="../images/noimage.png" class="card-img-top" alt="예정">
...
<div class="tab-pane fade" id="movie" role="tabpanel"><br />
	<div class="container">
	  <div class="row">
	  		<div class="col">
	  			<div class="card-imgs">
	  			<a href="novel_detail.do?novel_title=전지적 독자 시점">    			
	    			<img class="img" src="../images/noimage.png" class="card-img-top" alt="예정">
