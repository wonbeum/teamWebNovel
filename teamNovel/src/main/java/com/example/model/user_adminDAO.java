...
public class user_adminDAO {
	...
	public admin_userPagingTO userListsNickname( admin_userPagingTO userTO , String nickname ){
		...
		try {
			...
			String sql = "select user_email, user_nickname, user_gender, user_birth, user_cdate, user_grade from novel_user_information where user_nickname like ? order by user_cdate desc";
			pstmt = conn.prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY );
	...
	public admin_userPagingTO userListsEmail( admin_userPagingTO userTO , String email ){
		...
		try {
			...
			String sql = "select user_email, user_nickname, user_gender, user_birth, user_cdate, user_grade from novel_user_information where user_email like ? order by user_cdate desc";
			pstmt = conn.prepareStatement(sql, ResultSet.TYPE_SCROLL_INSENSITIVE, ResultSet.CONCUR_READ_ONLY );
